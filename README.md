# Mancala
Mancala is an ancient 2-player board game, which we implemented in Java using the MVC design pattern.

**Final Report**: [Link to Report](https://docs.google.com/document/d/1ZgaLUcJQiJBOKnD_eRwPi9mBpS5R1TcnLngyeQe0YZM/edit?usp=sharing)
